...
const ButtonHandler = ({ imageRef, cameraRef, videoRef }) => {
  ...
  return (
    <div className="btn-container grid grid-cols-3 gap-5 my-auto">
      {/* Image Handler */}
      {/* <input
        type="file"
        accept="image/*"
        ...
        ref={inputImageRef}
      />
      <button class="border-1 border-transparent py-2 border-black hover:border-white bg-black hover:bg-white"
        onClick={() => {
          // if not streaming
      ...
      <input
        ...
        ref={inputVideoRef}
      />
      <button className="border-1 border-transparent py-2 border-black hover:border-white bg-black hover:bg-white"
        onClick={() => {
          // if not streaming
      ...
      {/* Webcam Handler */}
      <button className="border-1 border-transparent px-4 py-2 border-black hover:border-white bg-black hover:bg-white"
        onClick={() => {
          // if not streaming
